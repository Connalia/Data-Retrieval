...
//για την πρόσβαση στο ευρετήριο
public class ReaderDemo {
    ...
    private void printIndexDocuments(IndexReader indexReader){
        try {
            ...
            for (int i=0; i<indexReader.maxDoc(); i++) { //το πλήθος των doc που έχει μέσα το ευρετήριο
                Document doc = indexReader.document(i);
                System.out.println("\tdocID="+doc.getField("docID")+"\ttitle:"+doc.get("title")+"\ttext:"+doc.get("text"));
            }
